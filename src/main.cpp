...
int run(int argc, char **argv) {
  ...
  options.add_options()("f,fasta", "Fasta file to mask",
      ...
      "multiple times.",
      cxxopts::value<std::vector<std::string>>())(
      "k,klen", "Kmer length to use for filter",
      cxxopts::value<uint64_t>()->default_value("31"))("h,help",
                                                       "Help message");
...
int run(int argc, char **argv) {
  ...
  cxxopts::Options options(
      "mask-fasta", "Mask fasta file with kmers found in another fasta file ");
  options.add_options()("f,fasta", "Fasta file to mask",
                        cxxopts::value<std::string>())(
      "r,reference", "Fasta file which kmers to use",
      cxxopts::value<std::vector<std::string>>())("h,help", "Help message");
...
void print_cmd_usage() {
  ...
  std::cerr << "      mask-fasta\tmask fasta file with kmers found in another "
            << "fasta file\n";
